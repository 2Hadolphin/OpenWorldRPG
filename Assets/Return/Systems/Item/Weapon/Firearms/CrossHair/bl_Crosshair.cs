...
namespace Return.Items.Weapons
{
    ...
    public class bl_Crosshair : bl_CrosshairBase
    {
        ...
        protected void OnEnable()
        {
            ...
            //RootContent.CharacterRoot.SetActive(bl_GameData.Instance.showCrosshair);
        }
        ...
        void ScaleContent()
        {
            ...
            Vector2 size = IsStable ? target - StableVector : target;
        ...
        //    int crossId = weaponCrosshairs.ToList().FindIndex(width => width.gunType == gun);
        //    if (crossId == -1)
        //    {
        ...
        public override void OnFire()
        {
            ...
            Vector2 size = IsStable ? new Vector2(GetCrosshair.OnFireScaleAmount, GetCrosshair.OnFireScaleAmount) - StableVector : new Vector2(GetCrosshair.OnFireScaleAmount, GetCrosshair.OnFireScaleAmount);
        ...
        private Vector2 StableVector
        {
            get 
            {
                return IsStable ? Vector2.one * OnCrouchReduce : Vector2.zero;
            }
        }
        // whetther motion stable **crouch **on anex
        bool IsStable =false;
