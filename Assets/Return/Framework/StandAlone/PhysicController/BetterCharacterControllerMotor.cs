...
namespace Return.Framework.PhysicController
{
    ...
    public class BetterCharacterControllerMotor : AbstractPhysicControllerMotor, ICharacterControllerMotor
    {
        #region IResolver
        ...
        public void SetCapsuleDimensions(float radius, float height, float yOffset)
        {
            ...
            // add floating offset
            //=Mathf.Clamp(CapsuleHeight - MaxStepHeight, CapsuleRadius * 2f, CapsuleHeight);
            var adjustHeight= Mathf.Clamp(CapsuleHeight- MaxStepHeight, 0, CapsuleHeight);
            Capsule.height = adjustHeight;
            Capsule.center = new Vector3(0f, CapsuleYOffset+MaxStepHeight, 0f);
        ...
        public void ValidateData()
        {
            ...
            CapsuleRadius = Mathf.Clamp(CapsuleRadius, 0f, CapsuleHeight);
            Capsule.direction = 1;
            ...
            MaxStepHeight = Mathf.Clamp(MaxStepHeight, 0f, CapsuleHeight);
