...
{
    [CustomPropertyDrawer(typeof(UTagPicker))]
    public class UTagPickerDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            GUILayout.Label(property.name.Replace("m_",string.Empty));
        ...
        public static void DrawTagField(SerializedProperty tag, UniversalTagDefinition definition,params GUILayoutOption[]options)
        {
            ...
            Assert.IsNotNull(a_customNames);
