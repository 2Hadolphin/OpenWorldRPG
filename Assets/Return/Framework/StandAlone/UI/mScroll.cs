...
//public class mEnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler
//{
//    #region Public
...
//    //private IBetterHorizontalOrVerticalLayoutGroup m_layoutGroup;
...
//        // m_layoutGroup.SpacingSizer.SetSize(this, spacing);
...
//            //_cellViewSizeArray.Add(_delegate.GetCellViewSize(this, i) + (i == 0 ? 0 :m_layoutGroup.SpacingSizer.OptimizedSize));
...
//                //_cellViewSizeArray.Add(_cellViewSizeArray[j] + (j == 0 ? m_layoutGroup.SpacingSizer.OptimizedSize : 0));
//            }
//        }
//    }
...
//        // layoutElement.minHeight = _cellViewSizeArray[cellIndex] - (cellIndex > 0 ? m_layoutGroup.SpacingSizer.OptimizedSize : 0);
//        else
//            layoutElement.minWidth = _cellViewSizeArray[cellIndex] - (cellIndex > 0 ? _layoutGroup.spacing : 0);
//        //layoutElement.minWidth = _cellViewSizeArray[cellIndex] - (cellIndex > 0 ? m_layoutGroup.SpacingSizer.OptimizedSize : 0);
...
//        if (!_container.TryGetComponent(out _layoutGroup))
//            if (scrollDirection == ScrollDirectionEnum.Vertical)
//                _layoutGroup = _container.gameObject.AddComponent<VerticalLayoutGroup>();
//            else
//                _layoutGroup = _container.gameObject.AddComponent<HorizontalLayoutGroup>();

//        //m_layoutGroup = _container.GetComponent<IBetterHorizontalOrVerticalLayoutGroup>();
//        _layoutGroup.spacing = spacing;
...
//        if (_initialized && spacing != _layoutGroup.spacing)//m_layoutGroup.SpacingSizer.OptimizedSize)
//        {
//            _updateSpacing = true;
//        }
//    }
...
//            {
//                MotionVelocity = new Vector2(Mathf.Clamp(Mathf.Abs(MotionVelocity.x), 0, maxVelocity) * Mathf.Sign(MotionVelocity.x), MotionVelocity.y);
//            }
//            else
//            {
//                MotionVelocity = new Vector2(MotionVelocity.x, Mathf.Clamp(Mathf.Abs(MotionVelocity.y), 0, maxVelocity) * Mathf.Sign(MotionVelocity.y));
//            }
//        }
//    }
