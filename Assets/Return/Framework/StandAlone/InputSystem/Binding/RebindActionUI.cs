...
/// </summary>
public class RebindActionUI : CustomWindow
{
    /// <summary>
    ...
    [SerializeField]
    public GameObject m_RebindOverlay;
    ...
    public void UpdateBindingID()
    {
        m_BindingId=m_Action.action.bindings[0].id.ToString();
        UpdateBindingDisplay();
    }
