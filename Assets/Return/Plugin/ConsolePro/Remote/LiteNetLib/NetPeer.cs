...
namespace FlyingWormConsole3.LiteNetLib
{
    ...
    public class NetPeer
    {
        ...
        private void ProcessMtuPacket(NetPacket packet)
        {
            ...
            //first stage _checkCache (mtu _checkCache and mtu ok)
            ...
            {
                _mtuCheckAttempts = 0;
                NetDebug.Write("[MTU] _checkCache. send back: " + receivedMtu);
        ...
        private void UpdateMtuLogic(int deltaTime)
        {
            ...
            lock (_mtuMutex)
            {
                ...
                //Must _checkCache result for MTU fix
