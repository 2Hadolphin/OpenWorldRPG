...
//     version 1.3.0
//     from Assets/Return/Plugin/NWH/Common/Scripts/Input/InputSystem/SceneInputActions.inputactions
//
    ...
    ""controlSchemes"": []
        ...
        public struct CameraControlsActions
        {
            ...
            public void SetCallbacks(ICameraControlsActions instance)
            {
                ...
                {
                    @ChangeCamera.started -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnChangeCamera;
                    @ChangeCamera.performed -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnChangeCamera;
                    @ChangeCamera.canceled -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnChangeCamera;
                    ...
                    @CameraPanning.started -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnCameraPanning;
                    @CameraPanning.performed -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnCameraPanning;
                    @CameraPanning.canceled -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnCameraPanning;
                    @CameraRotationModifier.started -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnCameraRotationModifier;
                    @CameraRotationModifier.performed -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnCameraRotationModifier;
                    @CameraRotationModifier.canceled -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnCameraRotationModifier;
                    @CameraPanningModifier.started -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnCameraPanningModifier;
                    @CameraPanningModifier.performed -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnCameraPanningModifier;
                    @CameraPanningModifier.canceled -= m_Wrapper.m_CameraControlsActionsCallbackInterface.OnCameraPanningModifier;
        ...
        public struct SceneControlsActions
        {
            ...
            public void SetCallbacks(ISceneControlsActions instance)
            {
                ...
                {
                    @ChangeVehicle.started -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnChangeVehicle;
                    @ChangeVehicle.performed -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnChangeVehicle;
                    @ChangeVehicle.canceled -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnChangeVehicle;
                    @FPSMovement.started -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnFPSMovement;
                    @FPSMovement.performed -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnFPSMovement;
                    @FPSMovement.canceled -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnFPSMovement;
                    @ToggleGUI.started -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnToggleGUI;
                    @ToggleGUI.performed -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnToggleGUI;
                    @ToggleGUI.canceled -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnToggleGUI;
                    @DragObjectModifier.started -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnDragObjectModifier;
                    @DragObjectModifier.performed -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnDragObjectModifier;
                    @DragObjectModifier.canceled -= m_Wrapper.m_SceneControlsActionsCallbackInterface.OnDragObjectModifier;
                }
