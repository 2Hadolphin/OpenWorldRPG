namespace CustomSkinningExample.Editor
{
    ...
    public static class RenderChunkHandler
    {
        ...
        public static float GetWeightDistance(this SkinPerVertex info1, SkinPerVertex info2)
        {
            bool[] isValidArray = new bool[8];
        ...
        public static float GetSimliarity(this RenderChunk chunk, int vtxIdx1, int vtxIdx21, int vtxIdx22, int vtxIdx23, float kernel)
        {
            int threeWeightCount = 0, index;
            int[] threeWeightIndexArray = new int[12];
            float[] threeWeightSumedWeightArray = new float[12];
        ...
        public static float GetSimliarity(this RenderChunk chunk, int vtxIdx1, int vtxIdx2, float kernel)
        {
            int sameIndexCount = 0;
            float[] weightArray = new float[8];
