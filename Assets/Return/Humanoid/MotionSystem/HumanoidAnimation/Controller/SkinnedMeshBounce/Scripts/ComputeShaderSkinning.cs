namespace CustomSkinningExample
{
    ...
    public static class DispatcherFactory
    {
        public static IDisposableDispatch CreateComputeBy(
            ...
            Func<ComputeBuffer> getRangeBoundsBuffer
            )
        {
            switch (method)
            {
                case SkinningBlend.Linear:
                    return new LinearBlendSkinningDispatcher(computeShader, chunk, bones, getPerVertexBuffer, getPerVertexSkinBuffer, getPerVertexStream, getRangeBoundsBuffer);
                case SkinningBlend.DualQuaternion:
                    return new DualQuaternionBlendSkinningDispatcher(computeShader, chunk, bones, getPerVertexBuffer, getPerVertexSkinBuffer, getPerVertexStream, getRangeBoundsBuffer);
                case SkinningBlend.OptimizedCenterOfRotation:
                    return new OptimizedCenterOfRotationSkinningDispatcher(computeShader, chunk, bones, getPerVertexBuffer, getPerVertexSkinBuffer, getPerVertexStream, getRangeBoundsBuffer);
                default:
                    return null;
            }
        }
    ...
    public class ComputeShaderSkinningAdapter : IRenderAdapter, IDisposable
    {
        ...
        public ComputeBuffer RangeBoundsBuffer;
        ...
        public ComputeShaderSkinningAdapter(SkinningBlend method, ComputeShader computeShader, RenderChunk chunk, Transform[] bones, Material material, bool tension = false)
        {
            ...
            RangeBoundsBuffer = new ComputeBuffer(1, Marshal.SizeOf<Vector3>() * 2, ComputeBufferType.Structured);
    ...
    public class DataToDataDispatcher : IDispatch
    {
        ...
        public DataToDataDispatcher(ComputeShader computeShader, Func<ComputeBuffer> getPerVertexBuffer, Func<ComputeBuffer> getPerVertexStream, Func<ComputeBuffer> getRangeBoundsBuffer)
        {
            uint maxThreadSizeY;
            uint maxThreadSizeZ;
            ...
            computeShader.SetBuffer(kernelIndex, "Distance", getRangeBoundsBuffer());
        }
