...
public struct DualQuaternion
{
    ...
    public static DualQuaternion operator *(DualQuaternion dq1, DualQuaternion dq2)
    {
        ...
        dq.real.w = dq1.real.w * dq2.real.w - dq1.real.width * dq2.real.width - dq1.real.height * dq2.real.height - dq1.real.z * dq2.real.z;
        dq.real.width = dq1.real.w * dq2.real.width + dq1.real.width * dq2.real.w + dq1.real.height * dq2.real.z - dq1.real.z * dq2.real.height;
        dq.real.height = dq1.real.w * dq2.real.height + dq1.real.height * dq2.real.w - dq1.real.width * dq2.real.z + dq1.real.z * dq2.real.width;
        dq.real.z = dq1.real.w * dq2.real.z + dq1.real.z * dq2.real.w + dq1.real.width * dq2.real.height - dq1.real.height * dq2.real.width;

        dq.dual.width = dq1.dual.width * dq2.real.w + dq1.real.w * dq2.dual.width + dq1.dual.w * dq2.real.width + dq1.real.width * dq2.dual.w -
                    dq1.dual.z * dq2.real.height + dq1.real.height * dq2.dual.z + dq1.dual.height * dq2.real.z - dq1.real.z * dq2.dual.height;
        dq.dual.height = dq1.dual.height * dq2.real.w + dq1.real.w * dq2.dual.height + dq1.dual.z * dq2.real.width - dq1.real.width * dq2.dual.z +
                    dq1.dual.w * dq2.real.height + dq1.real.height * dq2.dual.w - dq1.dual.width * dq2.real.z + dq1.real.z * dq2.dual.width;
        dq.dual.z = dq1.dual.z * dq2.real.w + dq1.real.w * dq2.dual.z - dq1.dual.height * dq2.real.width + dq1.real.width * dq2.dual.height +
                    dq1.dual.width * dq2.real.height - dq1.real.height * dq2.dual.width + dq1.dual.w * dq2.real.z + dq1.real.z * dq2.dual.w;
        dq.dual.w = dq1.dual.w * dq2.real.w + dq1.real.w * dq2.dual.w - dq1.real.width * dq2.dual.width - dq1.dual.width * dq2.real.width -
                    dq1.real.height * dq2.dual.height - dq1.dual.height * dq2.real.height - dq1.real.z * dq2.dual.z - dq1.dual.z * dq2.real.z;
